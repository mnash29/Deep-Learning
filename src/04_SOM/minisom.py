...
class MiniSom(object):
    def __init__(self, x, y, input_len, sigma=1.0, learning_rate=0.5, decay_function=None, random_seed=None):
        ...
        if sigma >= x/2.0 or sigma >= y/2.0:
            warn('Warning: sigma is too high for the dimension of the map.', stacklevel=1)
        if random_seed:
    ...
    def train_random(self, data, num_iteration):
        """ Train the SOM picking samples at random from data. """
    ...
    def train_batch(self, data, num_iteration):
        """ Train using all the vectors in data sequentially. """
    ...
    def activation_response(self, data):
        """
            Return a matrix where the element i,j is the number of times
    ...
    def quantization_error(self, data):
        """
            Return the quantization error computed as the average distance between
    ...
    def win_map(self, data):
        """
            Return a dictionary wm where wm[(i,j)] is a list with all the patterns
...
class TestMinisom:
    ...
    def test_quantization_error(self):
        ...
        assert self.som.quantization_error([4, 1]) == 0.5
